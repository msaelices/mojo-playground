...
a constant is required, e.g. as a type's size: `Array[Int, fib[10]()]`.
"""
...
def fib_sequence[n: Int]() -> Array[Int, n]:
    """The first `n` Fibonacci numbers; the `Array[Int, n]` return type is
    sized by the compile-time parameter, so it fits in a `comptime` binding."""
    var arr = Array[Int, n](fill=0)
    comptime if n >= 2:
        arr[1] = 1
